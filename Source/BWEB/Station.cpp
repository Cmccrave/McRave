			...
			if (mirrorHorizontal) {
				if (race == Races::Terran)
					...
					if (here != mainTile && here != naturalTile)
						returnValues.insert({ here + TilePosition(-2, 2), here + TilePosition(-2, 0), here + TilePosition(-2,-2), here + TilePosition(0, -2), here + TilePosition(2, -2) });
				}
			}
			else {
				returnValues.insert({ here + TilePosition(-2, 3), here + TilePosition(-2, 0), here + TilePosition(2, 3) });

				if (here != mainTile && here != naturalTile)
					returnValues.insert({ here + TilePosition(0, -2), here + TilePosition(2, -2), here + TilePosition(4, -2), here + TilePosition(4,0), here + TilePosition(4, 2) });
			}
		}
		else {
			if (mirrorHorizontal) {
				...
				if (race == Races::Terran)
					...
					if (here != mainTile && here != naturalTile)
						returnValues.insert({ here + TilePosition(-2, -1), here + TilePosition(-2, 1), here + TilePosition(-2, 3), here + TilePosition(0,3), here + TilePosition(2, 3) });
				}
			}
			else {
				...
				if (here != mainTile && here != naturalTile)
					returnValues.insert({ here + TilePosition(4, -1), here + TilePosition(4, 1), here + TilePosition(4, 3), here + TilePosition(0,3), here + TilePosition(2, 3) });
			}
		}
