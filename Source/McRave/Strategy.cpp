            ...
            if (enemyStrat.build.name == "2Gate" || enemyStrat.build.name == "1GateCore") {
                ...
                if (Players::ZvP()) {
                    ...
                    if ((!enemyStrat.expand.possible && Players::getTotalCount(PlayerState::Enemy, Protoss_Dragoon) >= 4)
                        ...
                        || (completesBy(2, Protoss_Dragoon, Time(4, 45)))
                        || (completesBy(3, Protoss_Dragoon, Time(5, 00)))
                        || (completesBy(5, Protoss_Dragoon, Time(5, 30)))
                        || (arrivesBy(2, Protoss_Dragoon, Time(5, 15)))
