...
namespace McRave::BuildOrder::Protoss {
    ...
    void PvT_2G_DT()
    {
        ...
        protossUnitPump[Protoss_Zealot]       = zealotsNeeded_PvT() > total(Protoss_Zealot);
        protossUnitPump[Protoss_Dragoon]      = com(Protoss_Templar_Archives) == 0;
    ...
    void PvT_2G_Robo()
    {
        ...
        protossUnitPump[Protoss_Reaver]  = true;
        protossUnitPump[Protoss_Shuttle] = vis(Protoss_Robotics_Support_Bay) > 0 && vis(Protoss_Shuttle) == 0;
    }
