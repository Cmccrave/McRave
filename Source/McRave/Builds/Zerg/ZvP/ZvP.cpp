...
namespace McRave::BuildOrder::Zerg {
    ...
    void ZvP2HatchMuta()
    {
        ...
        if (gasLimit > 0 && (Spy::getEnemyBuild() == "Unknown" || Spy::getEnemyBuild() == P_2Gate) && !atPercent(Zerg_Lair, 0.5))
            gasLimit = capGas(100);
    }
    ...
    void ZvP4HatchHydra()
    {
        ...
        auto firstHydraPump    = (vis(Zerg_Drone) >= 30 && total(Zerg_Hydralisk) < 24);
