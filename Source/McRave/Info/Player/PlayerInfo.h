...
namespace McRave {
    ...
    public:
        ...
        double maxGroundReach = 0;
        double maxAirReach    = 0;
        ...
        void operator+=(const Strength &second)
        {
            ...
            maxGroundReach = std::max(second.maxGroundReach, maxGroundReach);
            maxAirReach    = std::max(second.maxAirReach, maxAirReach);
        }
