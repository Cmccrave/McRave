...
namespace McRave::Players {
    ...
    bool hasUpgraded(PlayerState, BWAPI::UpgradeType, int level = 1);
...
namespace McRave {
    ...
    static inline int vis(BWAPI::UnitType t) { return Players::getVisibleCount(PlayerState::Self, t); }

    /// Returns the self owned completed unit count of this UnitType
    static inline int com(BWAPI::UnitType t) { return Players::getCompleteCount(PlayerState::Self, t); }
